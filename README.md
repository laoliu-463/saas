...
当前技术栈：Spring Boot / Java 17、Vue 3 / TypeScript、PostgreSQL、Redis、Docker Compose、Playwright。
...
```text
从 main 建短分支 → 修改 → 验证 → 提 PR → CI 通过后合并
```
...
真实上游验收使用 [real-pre 联调手册](./docs/验收/real-pre联调手册.md)，不能用 mock 数据冒充真实闭环。
