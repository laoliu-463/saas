...
[V1 必做] 运行时 Hook 以 `.claude/settings.json` 为准；工程门禁统一使用 `harness/policy/`、`harness/runbooks/` 和 `harness/checks/`，不在 `.claude/` 维护第二套守卫文档。
...
[V1 必做] 任何 real-pre 操作必须先读 `harness/policy/safety.md`、`harness/policy/real-pre.md` 与 `mcp/安全边界.md`。
