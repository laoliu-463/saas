...
> 最后更新：2026-06-28（#156 前端商品/订单/分析 API 对齐审计完成；#96/#135 因真实 pick_source 订单样本缺失保持 open）。
...
- GitHub 当前 open issue 为 20 个：#90、#92-#96、#98、#100-#101、#117、#123-#124、#129、#135、#147-#148、#157-#159、#164，全部属于 `DDD-COMPLETE-100` 新批次。
