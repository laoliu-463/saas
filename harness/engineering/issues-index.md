...
> 最后更新：2026-06-27（#64 商品快照 query 收口后）
...
- 当前 GitHub open leaf issues 为 #65-#76 与 #78；#77、#79-#89 当前不在 open 列表。
- #61 已完成商品同步 Application 收口；#62 已完成本地发布展示规则下沉；#63 已完成人工审核状态与操作日志语义 policy 收口；#64 已完成商品快照基础 query service 收口；四者均已在 GitHub 关闭。
