...
> 最后更新：2026-06-28（#157 达人/寄样页面领域 API 对齐完成；#96/#135 因真实 pick_source 订单样本缺失保持 open）。
...
- GitHub 当前 open issue 为 19 个：#90、#92-#96、#98、#100-#101、#117、#123-#124、#129、#135、#147-#148、#158-#159、#164，全部属于 `DDD-COMPLETE-100` 新批次。
