...
| `reports/current/` | 目录/文件 | MERGE/DELETE | `reports/` (收敛为不超过 50 个最新文件) | 文件过多、信息离散。 | 无 |
| `reports/latest-harness-inventory.md` | 报告 | KEEP | `reports/latest-harness-inventory.md` | 本次盘点报告，符合规则。 | 无 |
| `reports/` 历史流水报告 | 文件/目录 | ARCHIVE | `archive/reports-20260612-ddd-event-003-retired.zip` | DDD-EVENT-003 提交后 reports 根目录 88 个文件，超过当前每目录 50 文件限制。 | 历史证据需从 zip 追溯。 |
