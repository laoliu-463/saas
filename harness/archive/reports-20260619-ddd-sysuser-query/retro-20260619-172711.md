...
- Time: 2026-06-19 17:27:11 +08:00
...
DDD-BASELINE-001: restored backend testCompile baseline. Exposed stale target/classes class signature for LegacyOrderDomainFacade; fixed by deleting the single stale build artifact and recompiling. PowerShell Maven -D properties with dots must be quoted. Full agent-do was not used because worktree contains many unrelated dirty changes and git-push-safe would be unsafe.
