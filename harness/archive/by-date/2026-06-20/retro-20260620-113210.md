...
- Time: 2026-06-20 11:32:10 +08:00
...
Harness gate slice: check-harness-limits.ps1, harness README, and harness-structure-policy now agree with the already documented harness/engineering directory. This removes the repeated false-positive "engineering disallowed root dir" blocker observed in prior DDD slices.
Validation status: check-harness-limits.ps1 returned PASS. No backend/frontend runtime behavior changed; application build/restart/E2E were intentionally skipped for Scope=docs/harness.
No new DDD business rule was introduced.
