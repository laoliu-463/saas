...
- Time: 2026-06-20 11:42:10 +08:00
...
DDD user-domain slice: extracted CurrentUserPermissionPolicy from UserDomainService. UserDomainService now orchestrates persistence/password/logging and delegates current-user role-code resolution, data-scope code calculation, permission aggregation, and operation permission checks to the policy.
...
Harness status: check-harness-limits.ps1 is PASS after the earlier engineering allowlist fix.
