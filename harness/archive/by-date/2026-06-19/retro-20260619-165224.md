...
- Time: 2026-06-19 16:52:24 +08:00
...
DDD order query layer slice: removed Spring BeanUtils dependency from domain.order.query assemblers by introducing JDK Introspector based package helper. agent-do.ps1 was not used because this session is explicitly no commit/no push and agent-do invokes git push safe path. Full mvn test remains PARTIAL due unrelated existing failures outside this slice.
