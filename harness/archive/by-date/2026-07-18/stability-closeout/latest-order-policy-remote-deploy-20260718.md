...
- Time: 2026-07-18 13:35:13 +08:00
...
harness/reports/current/latest-order-policy-gate.md
~~~
...
saas-active-backend-real-pre-1    colonel-saas/backend:real-pre    "sh -c 'java $JAVA_O…"   backend-real-pre    53 seconds ago   Up 47 seconds (healthy)           127.0.0.1:8081->8080/tcp
saas-active-frontend-real-pre-1   colonel-saas/frontend:real-pre   "/docker-entrypoint.…"   frontend-real-pre   50 seconds ago   Up 5 seconds (health: starting)   127.0.0.1:3001->80/tcp
