...
- Time: 2026-06-20 13:22:00 +08:00
...
Project memory migration only. No Harness behavior upgrade required. ChatGPT Project URL redirected to login, and local repo / Downloads / Documents search found no ChatGPT Project export. External project memory content remains pending user export or explicit approval to use Chrome login state.
