...
- Time: 2026-06-23 01:44:33 +08:00
...
Remote deploy fixed-entry script exposed Docker Hub registry reachability/base-image metadata dependency. Fallback used verified local image artifact transfer plus remote compose up --no-build; consider adding first-class artifact deploy or remote branch parameter to deploy-remote.ps1.
