...
- Time: 2026-06-02 15:34:31 +08:00
- Environment: test
- Scope: docs
...
Added controlled content retirement workflow. agent-do dry-run passed with ContentMaintenance=plan. Actual run generated content-retire plan only; no archive/delete executed. Fixed PowerShell relative-path compatibility and UTF-8 document-debt parsing; document-debt candidates are review/resolve only. Non-dry-run agent-do was not used because current dirty worktree contains unrelated existing code/doc changes and would invoke git-push-safe.
