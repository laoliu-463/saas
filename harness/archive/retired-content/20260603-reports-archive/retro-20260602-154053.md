...
- Time: 2026-06-02 15:40:53 +08:00
- Environment: test
- Scope: docs
...
Continued with controlled content retirement. Archived one obsolete historical plan and deleted nine top-level transient files through manifests. Kept runtime/qa/out, playwright-report, test-results, tmp and start-real-pre.log as review candidates only. Updated document-debt register to mark archived plan as ARCHIVED and adjusted retire-content.ps1 to skip ARCHIVED/RESOLVED rows.
