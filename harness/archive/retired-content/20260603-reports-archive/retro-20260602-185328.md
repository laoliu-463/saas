...
- Time: 2026-06-02 18:53:28 +08:00
...
Updated Harness defaults to local real-pre, reordered agent-do to restart and health-check before business validation, and fixed evidence changed-file path collection. Verified with real-pre safety-check, PowerShell parse, collect-evidence dry-run, and agent-do docs dry-run.
