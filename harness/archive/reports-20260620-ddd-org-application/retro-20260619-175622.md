...
- Time: 2026-06-19 17:56:22 +08:00
...
DDD-USER continuation: OrgAssignmentPolicy is a Spring component and OrgStructureService now receives it via constructor injection; user/order DDD regressions passed; backend package, restart and health verified. agent-do not used because it calls git-push-safe in a broad dirty worktree.
