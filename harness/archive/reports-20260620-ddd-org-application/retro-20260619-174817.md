...
- Time: 2026-06-19 17:48:17 +08:00
...
DDD-USER U-7/U-8 continuation: added OrgAssignmentPolicy and delegated OrgStructureService resolve/split assignment to it without public API change; simplified LegacyOrderDomainFacade dataScope filtering to DataScopePolicy.applyTo. Verification passed: test-compile, 128 targeted tests, backend package, restart-compose backend, verify-local backend health. agent-do not used because it calls git-push-safe in a broad dirty worktree. Stale/corrupt target/classes was observed again and resolved by recompilation.
