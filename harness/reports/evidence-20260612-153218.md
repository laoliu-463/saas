...
- Time: 2026-06-12 15:32:23 +08:00
...
saas-active-backend-real-pre-1    colonel-saas/backend:real-pre    "sh -c 'java $JAVA_O…"   backend-real-pre    9 seconds ago   Restarting (1) Less than a second ago
...
~~~text
NAMES                             STATUS                                  PORTS
saas-active-backend-real-pre-1    Restarting (1) Less than a second ago
