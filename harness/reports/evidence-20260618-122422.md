...
- Time: 2026-06-18 12:24:23 +08:00
...
~~~text
harness/reports/content-retire-20260618-122422.md
~~~
...
saas-active-frontend-real-pre-1   colonel-saas/frontend:real-pre   "/docker-entrypoint.…"   frontend-real-pre   35 seconds ago   Up 6 seconds (health: starting)   127.0.0.1:3001->80/tcp
...
saas-active-redis-real-pre-1      redis:7-alpine                   "docker-entrypoint.s…"   redis-real-pre      4 days ago       Up 3 hours (healthy)              6379/tcp
~~~
