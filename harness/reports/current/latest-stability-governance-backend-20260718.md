...
- Time: 2026-07-18 09:29:38 +08:00
...
saas-active-backend-real-pre-1                 colonel-saas/backend:real-pre                                             "sh -c 'java $JAVA_O…"   backend-real-pre    2 minutes ago   Up 4 seconds (health: starting)   127.0.0.1:8081->8080/tcp
...
NAMES                                          STATUS                            PORTS
saas-active-backend-real-pre-1                 Up 4 seconds (health: starting)   127.0.0.1:8081->8080/tcp
...
agent-do failed: Local verification failed.
