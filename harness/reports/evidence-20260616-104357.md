...
- Time: 2026-06-16 10:43:58 +08:00
...
~~~text
harness/reports/content-retire-20260616-104357.md
...
saas-active-postgres-real-pre-1   postgres:15-alpine               "docker-entrypoint.s…"   postgres-real-pre   2 days ago    Up 21 hours (healthy)   5432/tcp
saas-active-redis-real-pre-1      redis:7-alpine                   "docker-entrypoint.s…"   redis-real-pre      2 days ago    Up 21 hours (healthy)   6379/tcp
~~~
