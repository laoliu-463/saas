...
- Time: 2026-06-29 16:24:50 +08:00
- Environment: real-pre
- Scope: docs
- Branch: codex/ddd-user-role-application
- Commit: pre-final docs commit; automatic `f12bb603` was reset before final commit because it included pre-existing backend dirty outside docs scope
