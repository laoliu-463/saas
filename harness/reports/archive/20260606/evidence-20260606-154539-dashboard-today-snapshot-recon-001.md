...
（今日样本全部为 `order_status=1`，无�?383 单仍�?`performance_records` 标记 `is_valid=false`�?
...
| `frontend/.../data/index.vue` L479-483 | �?`serviceFeeExpense` �?fallback `commission` |
...
| 服务费收�?毛利公式 | FAIL |
| 结算�?| BLOCKED（无样本�?|
| 建议下一�?| **DASH-RECON-MONEY-DRIFT-001** |
