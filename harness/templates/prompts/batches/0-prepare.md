...
|---|---|---|---|
| DDD-BASE-001 | Infra | DONE | `harness/reports/ddd-base-001-refactor-switches.md` |
| DDD-BASE-002 | Test | PARTIAL | `harness/reports/ddd-base-002-characterization.md`（受 SAMPLE-005-FIX 阻塞） |
| DDD-BASE-003 | Coordinator | DONE | 看板 / 依赖图 |
| DDD-BASE-004 | Infra | DONE | `harness/reports/ddd-base-004-package-structure.md` |
...
请执行：
1. 读 `harness/tasks/ddd-multi-agent-board.md` + `harness/tasks/ddd-task-dependency-graph.md`
...
4. 输出 Batch 0 启动报告 `harness/reports/ddd-batch-0-prepare.md`
5. 不 push；不合并；不改业务代码
```
