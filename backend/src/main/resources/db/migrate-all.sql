...
-- ============================================================
\i /docker-entrypoint-initdb.d/db/alter-colonel-activity-recruiter-assignment.sql
\i /docker-entrypoint-initdb.d/db/alter-role-code-merge-colonel-leader.sql
\i /docker-entrypoint-initdb.d/db/alter-colonel-activity-product-state-split.sql
\i /docker-entrypoint-initdb.d/db/alter-colonelsettlement-order-dual-track.sql
\i /docker-entrypoint-initdb.d/db/alter-ops-staff-data-scope-20260520.sql
\i /docker-entrypoint-initdb.d/db/alter-order-pay-time.sql
\i /docker-entrypoint-initdb.d/db/alter-sys-dept-uuid-canonical-20260530.sql
\i /docker-entrypoint-initdb.d/db/alter-talent-claim-shipping-address.sql
\i /docker-entrypoint-initdb.d/db/create-colonel-order-settlement.sql
\i /docker-entrypoint-initdb.d/db/alter-product-activity-backfill-state-20260615.sql
\i /docker-entrypoint-initdb.d/db/alter-product-library-query-performance-20260625.sql
\i /docker-entrypoint-initdb.d/db/migrate-sys-dept-dept-type.sql
\i /docker-entrypoint-initdb.d/db/alter-sample-default-standard-disable-20260716.sql
\i /docker-entrypoint-initdb.d/db/alter-authorization-foundation-20260713.sql
\i /docker-entrypoint-initdb.d/db/alter-role-aware-promotion-link-attribution-20260716.sql
\i /docker-entrypoint-initdb.d/db/alter-order-default-attribution-dimensions-20260716.sql
\i /docker-entrypoint-initdb.d/db/alter-performance-final-attribution-20260716.sql
\i /docker-entrypoint-initdb.d/db/alter-cso-dual-attribution-status-20260716.sql
