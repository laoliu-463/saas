...
public class SampleCooperationApplicationService {
    ...
    public SampleCopyTextVO copyPromotion(
        ...
        String activityId = firstText(sample.getActivityId(), visible.getActivityId());
        String productId = firstText(sample.getActivityProductId(), visible.getProductExternalId());
