...
public class SampleApplicationService {
    ...
    public SampleEditContextVO updateCooperationDetails(
            UUID id, SampleCooperationUpdateRequest request, UUID userId, UUID deptId,
            DataScope dataScope, Object roleCodes) {
    ...
    public SamplePrivateNoteVO updatePrivateNote(
            UUID id, SamplePrivateNoteRequest request, UUID userId, UUID deptId,
            DataScope dataScope, Object roleCodes) {
    ...
    public SampleCopyTextVO copyPromotion(
            UUID id, UUID userId, UUID deptId, DataScope dataScope, Object roleCodes, String idempotencyKey) {
    ...
    public SampleCopyTextVO copyOrder(
            UUID id, UUID userId, UUID deptId, DataScope dataScope, Object roleCodes) {
        return sampleCooperationApplicationService.copyOrder(id, userId, deptId, dataScope, roleCodes);
    }
    ...
    public ApiResult<SampleVO> refreshLogistics(
            UUID id, UUID userId, UUID deptId, DataScope dataScope, Object roleCodes) {
        ApiResult<SampleVO> result = sampleCommandApplicationService.refreshLogistics(id, userId, deptId, dataScope, roleCodes);
        enrichOne(result == null ? null : result.getData(), userId, roleCodes);
        return result;
    }
    ...
    private void enrichOne(SampleVO sample, UUID currentUserId, Object roleCodes) {
        ...
        sample.setActionAvailability(cooperationActionPolicy.availability(
                status, sample.getApplicantUserId(), currentUserId, roleCodes));
    }
}
