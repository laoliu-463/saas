...
public class OrderQueryService {
    ...
    private OrderDetailResponse.SampleInfo findSampleInfo(
    ...
    private String unattributedReasonText(String value) {
        if (!StringUtils.hasText(value)) {
            return null;
        }
        return switch (value) {
    ...
    private String unattributedReasonSuggestion(String value) {
        if (!StringUtils.hasText(value)) {
            return null;
        }
        return switch (value) {
    ...
    private UUID uuidValue(String raw) {
