...
class AuthApplicationTest {
    ...
    void login_success_shouldReturnTokenAndUserInfo() {
        ...
        LoginResponse response = authApplication.login(request);
    ...
    void login_userNotFound_shouldThrow() {
        ...
        assertThatThrownBy(() -> authApplication.login(request))
    ...
    void refreshToken_success_shouldReturnNewToken() {
        ...
        RefreshResponse response = authApplication.refreshToken(request);
    ...
    void refreshToken_shouldResolveDataScopeWithNormalizedRoleCodes() {
        ...
        authApplication.refreshToken(request);
    ...
    void refreshToken_invalidToken_shouldThrow() {
        ...
        assertThatThrownBy(() -> authApplication.refreshToken(request))
                .isInstanceOf(BusinessException.class)
    ...
    void logout_missingRefreshToken_shouldThrow() {
        ...
        assertThatThrownBy(() -> authApplication.logout(request))
                .isInstanceOf(BusinessException.class)
    ...
    void refreshToken_revokedByLogout_shouldThrow() {
        ...
        authApplication.logout(logoutRequest);

        RefreshRequest refreshRequest = new RefreshRequest();
        refreshRequest.setRefreshToken("valid.refresh.token");

        assertThatThrownBy(() -> authApplication.refreshToken(refreshRequest))
                .isInstanceOf(BusinessException.class)
    ...
    void isTokenBlacklisted_tokenInBlacklist_shouldReturnTrue() {
        ...
        boolean result = authApplication.isTokenBlacklisted("blacklisted.token");
    ...
    void isTokenBlacklisted_tokenNotInBlacklist_shouldReturnFalse() {
        ...
        boolean result = authApplication.isTokenBlacklisted("valid.token");
    ...
    void isTokenBlacklisted_redisReturnsNull_shouldReturnFalse() {
        ...
        boolean result = authApplication.isTokenBlacklisted("some.token");
