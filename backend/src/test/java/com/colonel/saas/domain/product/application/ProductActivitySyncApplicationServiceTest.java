...
class ProductActivitySyncApplicationServiceTest {
    ...
    @Test
    void refreshManualActivitySnapshots_shouldBuildClampedRequestAndDelegate() throws Exception {
        ProductActivitySyncApplicationService applicationService =
                new ProductActivitySyncApplicationService(productService);
        ...
        Method method = ProductActivitySyncApplicationService.class.getDeclaredMethod(
                "refreshManualActivitySnapshots",
                String.class,
                String.class,
                Integer.class);
        ProductActivitySyncApplicationService.ActivityProductRefreshResult result =
                (ProductActivitySyncApplicationService.ActivityProductRefreshResult)
                        method.invoke(applicationService, " ACT-1 ", "APP-1", 100);
