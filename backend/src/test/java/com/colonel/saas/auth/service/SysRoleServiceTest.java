...
/**
 * DDD-USER-MIGRATION-014（Issue #23）— SysRoleService Legacy 委派壳测试。
 *
 * <p>SysRoleService 现在是瘦壳，所有 6 个方法委派到 SysRoleApplication。
 * 行为细节由 {@code SysRoleApplicationTest} 覆盖。</p>
 */
