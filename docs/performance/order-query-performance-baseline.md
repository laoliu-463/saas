...
- `product_snapshot`: `idx_product_snapshot_activity`、`idx_product_snapshot_product`、`idx_product_snapshot_deleted`、`idx_ps_activity_active_count`（`activity_id`，`deleted=0` 部分索引）
