...
- 当前文档和模板统一使用 `docs/harness-maintenance/legacy-rules/`、`harness/scripts/commands/` 路径；历史 ADR 中明确描述旧记录的路径保持不变。
...
### v0.7.1 — 2026-06-20
- Harness/docs 路径口径校正：DDD 路线图、任务矩阵、Gate、Domain Map、multi-agent 提示词索引统一指向 `docs/harness-maintenance/legacy-rules/...` 与 `harness/scripts/commands/...`。
