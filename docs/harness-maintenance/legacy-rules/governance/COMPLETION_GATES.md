...
- docs/harness-maintenance/legacy-rules/changelog.md: updated / not needed
...
7. 未更新 `docs/harness-maintenance/legacy-rules/state/snapshots/DOMAIN_STATUS.md` / `docs/harness-maintenance/legacy-rules/state/snapshots/01-当前项目状态.md` 就结束任务，不得 DONE。
