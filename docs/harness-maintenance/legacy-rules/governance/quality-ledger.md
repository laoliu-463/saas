...
> **与 `docs/harness-maintenance/legacy-rules/state/snapshots/DOMAIN_STATUS.md` 的分工**：
> - 本文件（`QUALITY_LEDGER.md`）：9 个模块的**质量等级**与下一步指针。
> - `docs/harness-maintenance/legacy-rules/state/snapshots/DOMAIN_STATUS.md`：每个领域的**详细状态 / 报告路径 / 风险**。
> - 业务 DEBT 优先进 `docs/harness-maintenance/legacy-rules/state/snapshots/03-P0-P1问题台账.md` / `docs/harness-maintenance/legacy-rules/state/snapshots/KNOWN_ISSUES.md`；harness DEBT 必进 `docs/harness-maintenance/legacy-rules/state/debts/HARNESS_DEBT.md`。
> 本文件不替代 `docs/harness-maintenance/legacy-rules/state/debts/HARNESS_DEBT.md` 的详细债务登记。
...
5. 本文件不替代 `docs/harness-maintenance/legacy-rules/state/snapshots/DOMAIN_STATUS.md` 的详细状态，只作为快速概览。
