...
- `docs/harness-maintenance/legacy-rules/state/snapshots/DOMAIN_STATUS.md` 的用户域状态。
- 相关 evidence report 和 `docs/harness-maintenance/legacy-rules/state/snapshots/KNOWN_ISSUES.md`。
