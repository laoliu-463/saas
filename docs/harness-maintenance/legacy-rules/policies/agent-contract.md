...
<<<<<<< HEAD:docs/harness-maintenance/legacy-rules/policies/agent-contract.md
...
>>>>>>> b8cb837b (refactor: establish real-pre single-channel CD):harness/rules/policies/agent-contract.md
