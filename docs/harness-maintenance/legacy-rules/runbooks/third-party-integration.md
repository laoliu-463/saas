...
2. 读取 `docs/验收/real-pre联调手册.md` 和 `docs/harness-maintenance/legacy-rules/skills/ddd/real-pre-debug.skill.md`。
...
- 后端日志摘要。
- `docs/验收/验收证据索引.md`；Harness 侧只在 `docs/harness-maintenance/legacy-rules/state/snapshots/04-real-pre证据索引.md` 保留执行摘要。
