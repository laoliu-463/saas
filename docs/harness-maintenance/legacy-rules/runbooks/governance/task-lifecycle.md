...
> 本 runbook 是 `docs/harness-maintenance/legacy-rules/policies/agent-contract.md`、`docs/harness-maintenance/legacy-rules/governance/COMPLETION_GATES.md` 和 `docs/harness-maintenance/legacy-rules/governance/session-exit-gate.md` 的执行流程视图。
...
2. 读取 `docs/harness-maintenance/legacy-rules/state/snapshots/01-当前项目状态.md`。
3. 读取 `docs/harness-maintenance/legacy-rules/governance/task-routing.md` 找到对应任务类型必读文件。
...
7. 阅读 `docs/harness-maintenance/legacy-rules/governance/forbidden-scope.md`，明确本任务**禁止**做哪些事。
8. 判断是否需要：
   - 重启本地容器？
   - 远端部署？
   - 真实样本 / Token / 权限包？
...
5. 把当前 `git status --short` 中的 dirty 归入十种分类之一（参见 `docs/harness-maintenance/legacy-rules/skills/git/git-change-control.md` 第 3 节）。
...
详细命令矩阵见 `docs/harness-maintenance/legacy-rules/runbooks/governance/scope-command-matrix.md`。
...
1. 生成或覆盖 `runtime/qa/out/latest-<report-key>.md`（docs-only 可参考 `docs/harness-maintenance/templates-history/docs-only-template.md`）。
2. 在 evidence 中写 retro 结论；仅当存在责任人、改进动作和验证方式时，按 `docs/harness-maintenance/templates-history/retro-summary-template.md` 生成独立 retro。
3. 更新 `docs/harness-maintenance/legacy-rules/state/snapshots/01-当前项目状态.md` 的相关状态（如有变化）。
4. 更新 `docs/harness-maintenance/legacy-rules/state/snapshots/DOMAIN_STATUS.md` 中本轮涉及领域的状态。
5. 更新 `docs/harness-maintenance/legacy-rules/changelog.md` 一行。
6. 更新 `docs/harness-maintenance/legacy-rules/state/debts/HARNESS_DEBT.md`（如本轮有新增 / 关闭 DEBT）。
...
**必做动作**（按 `docs/harness-maintenance/legacy-rules/governance/session-exit-gate.md`）：
...
- `docs/harness-maintenance/legacy-rules/policies/agent-contract.md`
...
- `docs/harness-maintenance/legacy-rules/governance/session-exit-gate.md`
- `docs/harness-maintenance/legacy-rules/governance/forbidden-scope.md`
- `docs/harness-maintenance/legacy-rules/skills/git/git-change-control.md`
- `docs/harness-maintenance/legacy-rules/skills/git/git-batch-submit.md`
- `docs/harness-maintenance/legacy-rules/skills/workflow/post-task-gc.md`
- `docs/harness-maintenance/legacy-rules/runbooks/governance/scope-command-matrix.md`
- `docs/harness-maintenance/legacy-rules/runbooks/governance/closeout-and-gc.md`
- `docs/harness-maintenance/legacy-rules/runbooks/governance/debt-governance.md`
