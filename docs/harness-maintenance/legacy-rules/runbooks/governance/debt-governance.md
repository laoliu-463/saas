...
`unknown` dirty **必须**额外生成 `runtime/qa/out/unknown-dirty-investigation-*.md`，并在 SESSION_EXIT_GATE.md 的 Git State Clean 中标 `BLOCKED_DIRTY_UNKNOWN`。

## 5. Report Rotation（报告归档）

`runtime/qa/out/` 累计触发归档的条件：
...
- `docs/harness-maintenance/templates-history/garbage-collection-policy.md`
- `docs/harness-maintenance/legacy-rules/skills/workflow/post-task-gc.md`
- `docs/harness-maintenance/legacy-rules/changelog.md`
- `docs/harness-maintenance/legacy-rules/state/snapshots/01-当前项目状态.md`
