...
> Harness 自身的迭代路线图。区别于 `docs/harness-maintenance/legacy-rules/runbooks/ddd/DDD_OPTIMIZATION_ROADMAP.md`（业务 DDD 路线图）。

## 0. 当前版本

- `docs/harness-maintenance/legacy-rules/changelog.md` 最新条目见该文件。
...
| 路线图 | 关注 |
| --- | --- |
| `docs/harness-maintenance/legacy-rules/runbooks/ddd/DDD_OPTIMIZATION_ROADMAP.md` | 业务 DDD 优化 |
| `docs/harness-maintenance/legacy-rules/runbooks/ddd/DDD_DOMAIN_TASK_MATRIX.md` | 业务领域任务矩阵 |
| `HARNESS_ITERATION_ROADMAP.md`（本文件） | Harness 自身迭代 |
| `docs/harness-maintenance/legacy-rules/state/debts/HARNESS_DEBT.md` | 债务登记 |
| `docs/harness-maintenance/legacy-rules/changelog.md` | 变更日志 |
| `docs/harness-maintenance/legacy-rules/state/snapshots/01-当前项目状态.md` | 项目当前状态 |
...
- `docs/harness-maintenance/legacy-rules/state/debts/HARNESS_DEBT.md` 中某条 DEBT 关闭后衍生新债务。
...
- `docs/harness-maintenance/legacy-rules/state/debts/HARNESS_DEBT.md`
- `docs/harness-maintenance/legacy-rules/changelog.md`
