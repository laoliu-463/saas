...
| 顺序 | 批次 | 内容 | 部署 |
|---|---|---|---|
| 1 | reports | `runtime/qa/out/latest-<key>.md`（仅需独立 evidence batch 时） | 否 |
...
### G. 报告收口
更新 `docs/harness-maintenance/legacy-rules/state/snapshots/01-当前项目状态.md`、`docs/harness-maintenance/legacy-rules/state/snapshots/DOMAIN_STATUS.md`、`docs/harness-maintenance/legacy-rules/changelog.md`。
