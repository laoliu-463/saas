...
> 详细说明以 `docs/harness-maintenance/legacy-rules/environment/envs/*.md` 为准；本表只做快速索引。
...
- `docs/harness-maintenance/legacy-rules/environment/README.md`
- `docs/harness-maintenance/legacy-rules/environment/envs/test-env.md`
- `docs/harness-maintenance/legacy-rules/environment/envs/real-pre-env.md`
- `docs/harness-maintenance/legacy-rules/environment/envs/remote-real-pre-env.md`
- `docs/harness-maintenance/legacy-rules/environment/envs/docker-compose-map.md`
- `docs/harness-maintenance/legacy-rules/environment/envs/local-dev-env.md`
- `docs/harness-maintenance/legacy-rules/runbooks/governance/scope-command-matrix.md`
- `docs/harness-maintenance/legacy-rules/runbooks/remote-deploy.md`
