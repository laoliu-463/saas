...
| --- | --- | --- | --- | --- |
| DDD-BASE-001 | Infra | DONE | `8f1244a6` | `runtime/qa/out/ddd-base-001-refactor-switches.md` |
| DDD-BASE-003 | Architecture Guard | DONE | `86b16922` | `runtime/qa/out/ddd-dependency-map.md` |
| DDD-BASE-004 | Infra | DONE | `1ab9cd92` | `runtime/qa/out/ddd-base-004-package-structure.md` |
...
| --- | --- | --- | --- | --- |
| DDD-PROGRESS-AUDIT | Integration | DONE | `712df1ed` + `626d779e` | `runtime/qa/out/ddd-progress-audit-2026-06-13.md` + `harness/handovers/DDD-PROGRESS-AUDIT-handover.md` |
...
| DDD-VERIFY-SPRINT1-P0 | Integration | DONE | `34c8ae57` | `runtime/qa/out/ddd-sprint1-p0-stage-acceptance-2026-06-13.md` (PARTIAL_PASS 35/53) |
| DDD-PERF-005 | Performance | DONE | `70b2e287` + `46675e9d` | `runtime/qa/out/ddd-perf-005-2026-06-13.md` ExclusiveMerchant service + PerformanceAttributionPolicy |
| DDD-TALENT-004 | Talent | DONE | `d9a33028` + `b399701f` + `679223a6` | `runtime/qa/out/ddd-talent-004-2026-06-13.md` ExclusiveTalent service |
| DDD-SAMPLE-001 | Sample | DONE | `7efee009` | `runtime/qa/out/ddd-sample-001-2026-06-13.md` 统一 SampleApplicationService（合并 Query/Command 两个 service） |

## Batch 8 - 订单域 query/sync 解耦（owner 集成分支）

| task_id | owner | 状态 | commit | 报告 / handover |
| --- | --- | --- | --- | --- |
| DDD-ORDER-005 | Order | DONE | `8b49dd12` + `dbdfdbb2` | `docs/harness-maintenance/tasks-history/DDD-ORDER-005-handover.md` OrderDomainEventPublisher + InProcessOrderDomainEventPublisher + OrderEventPayloadMapper + OrderSyncedEvent payload 补齐 |
| DDD-ORDER-006 | Order | DONE | `eb3be708` + `8cd3a8c0` + `0f6dd1d4` | `docs/harness-maintenance/tasks-history/DDD-ORDER-006-handover.md` OrderQueryView + OrderDetailView，Controller/Facade 不再暴露 Entity |
...
1. **P0** 下一批任务前先归档 `runtime/qa/out/`，当前 reports 已达 50/50 文件上限。
...
- 详细 evidence：`runtime/qa/out/ddd-clean-002-2026-06-13.md`
...
- `docs/harness-maintenance/tasks-history/DDD-SPRINT1-P0-handover.md`（Sprint 1 P0 第一批 5 个任务 stage 验收）
- `docs/harness-maintenance/tasks-history/DDD-ORDER-005-handover.md`（订单域事件发布收敛）
- `docs/harness-maintenance/tasks-history/DDD-ORDER-006-handover.md`（订单 query/sync 模型解耦）
- `docs/harness-maintenance/tasks-history/ddd-sample-005-fix-sample-agent-handover.md`（历史，Sample 重写）
