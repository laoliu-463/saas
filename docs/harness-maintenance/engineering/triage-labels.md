...
- `docs/harness-maintenance/engineering/issue-tracker.md` —— issue tracker 配置
- `docs/harness-maintenance/engineering/context.md` —— 上下文文档
- `docs/harness-maintenance/engineering/issues-index.md` —— GitHub Issues 镜像（待建立）

## 变更历史

- **v1.0**（初始）：位于 `docs/agents/triage-labels.md`，5 个 canonical 标签
- **v2.0**（2026-06-19）：迁移到 `docs/harness-maintenance/engineering/triage-labels.md`，新增流转规则文档