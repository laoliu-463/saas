...
| Issue | 本地状态 | 证据 |
| --- | --- | --- |
| #16 UserAssignmentPolicy | LOCAL VERIFIED，GitHub 状态待同步 | `runtime/qa/out/evidence-20260620-200000-UserAssignmentPolicy.md` |
| #21 SysUserCRUDApplicationA | LOCAL VERIFIED，GitHub 状态待同步 | `runtime/qa/out/evidence-20260620-223000-SysUserCRUDApplicationA.md` |
| #22 SysUserCRUDApplicationB | LOCAL VERIFIED + 已接入 `SysUserService` live path | `runtime/qa/out/latest-evidence-20260620.md` |
| #18 SysUserAssignmentApplication | LOCAL VERIFIED，已以 `SysUserGroupMembershipApplication` 承接群组成员加入/移除 live path | `runtime/qa/out/latest-evidence-20260620.md` |
...
- [`docs/harness-maintenance/engineering/issue-tracker.md`](./issue-tracker.md) —— Issue tracker 配置
- [`docs/harness-maintenance/engineering/triage-labels.md`](./triage-labels.md) —— 标签映射
- [`docs/harness-maintenance/engineering/context.md`](./context.md) —— 上下文文档规则
