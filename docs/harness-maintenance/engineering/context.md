...
寄样复制推广文案、活动商品事实或寄样详情回填变更，还必须读取 [`docs/领域/寄样域.md`](../../docs/领域/寄样域.md)，并以“新申请固化事实 + 历史申请快照回填 + 商品主记录缺失”作为最小回归集。
...
3. **当前阶段相关 `docs/*.md`**
4. **`CONTEXT.md`**
5. **`docs/harness-maintenance/engineering/`**
6. **skill 自身默认流程**
...
- [`harness/README.md`](../INDEX.md) —— Harness 总入口

## 变更历史

- **v1.0**（初始）：位于 `docs/agents/domain.md`，single-context 模式
- **v2.0**（2026-06-19）：迁移到 `docs/harness-maintenance/engineering/context.md`，与 harness 完全融合
