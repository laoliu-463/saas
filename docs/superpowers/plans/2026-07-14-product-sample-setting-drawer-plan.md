...
**Files:**
- Generate: `runtime/qa/out/latest-product-sample-setting-drawer.md`
- Modify: `docs/harness-maintenance/legacy-rules/state/snapshots/DOMAIN_STATUS.md` only if the fixed entry requires a domain status update for this task.
